...
VERIFICATION_EMAIL_BODY = "Error! This email body is a no-go. Can you draft another one for us?"
VERIFICATION_EMAIL_SUBJECT = "Something's up with your email subject. Maybe it's shy? Let's try again."
...
RESET_PASSWORD_MESSAGE = "Error! There's something fishy about this password reset message. Time for a rewrite?"
RESET_PASSWORD_EMAIL_SUBJECT = "Your reset password email subject doesn't quite ring true. Time for a retune?"
NO_USER_REGISTERED_WITH_EMAIL = "Oh dear! This email seems lonely. There's no user registered with it."
RESET_PASSWORD_LINK_SENT_MESSAGE = "Drats! We're having trouble sending the reset password link. It refuses to leave the nest."
