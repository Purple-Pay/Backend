...
USER_ID_AUTH_ID_MISMATCH = "Oops! Your User ID and Auth ID seem to be in a pickle. They're not matching. 🥒"
CREATE_APIKEY_SUCCESS = "Woohoo! You’ve created an API key. It's like you just had a digital baby!"
